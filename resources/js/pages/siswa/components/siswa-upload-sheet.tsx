...
const SiswaUploadMediaSheet: FC<Props> = ({ siswa, children }) => {
  ...
  const handleUploadMedia = () => {
    post(route('siswa.upload-media', siswa.id), {
      preserveScroll: true,
      onSuccess: () => {
    ...
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      <SheetContent>
        <SheetHeader>
          ...
          <SheetDescription>Upload media to siswa</SheetDescription>
        </SheetHeader>
...
export default SiswaUploadMediaSheet;
